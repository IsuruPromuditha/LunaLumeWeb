...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <section class="relative overflow-hidden rounded-lg mb-12" data-aos="fade-up">
        ...
        <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center text-white">
            <h1 class="text-5xl md:text-6xl font-bold mb-4" data-aos="fade-down">LunaLume</h1>
    ...
    <section class="mb-12 bg-gray-100 py-12 rounded-lg" data-aos="fade-up">
        <h2 class="text-3xl font-semibold text-center mb-8" data-aos="fade-up">What Our Customers Say</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div class="bg-white p-6 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="100">
                <p class="text-gray-600 italic">"Kings Clothing has the best selection of trendy outfits! The quality is amazing, and delivery is super fast."</p>
                <p class="mt-4 font-semibold text-gray-800">Sarah M.</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="200">
                <p class="text-gray-600 italic">"I love the variety of brands available. Found my favorite Nike T-shirt at a great price!"</p>
                <p class="mt-4 font-semibold text-gray-800">James T.</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="300">
                <p class="text-gray-600 italic">"The customer service is top-notch. They helped me find the perfect dress for an event."</p>
                <p class="mt-4 font-semibold text-gray-800">Emma L.</p>
            </div>
        </div>
    </section>
